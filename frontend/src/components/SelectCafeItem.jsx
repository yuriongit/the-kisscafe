...
export default function SelectCafeItem ({ selectedItem, setSelectedItem, capitalize }) {
    return (
        <>
            {selectedItem && (
                <div className="bg-orange-500/25 p-2.5 rounded-lg">
                    <div className="min-w-250 flex-col bg-white/10 gap-2.5 flex justify-between rounded-lg p-7.5 min-h-[70%]">
                        <div className="w-full flex border-b border-b-black/25 justify-between items-start">
                            <div className="flex flex-col pb-5 space-y-2.5">
                                <label className="text-3xl font-thin text-black/75">
                            ...
                            <div>
                                <ul className="grid grid-cols-2 py-5 gap-2.5 h-full">
                                    <li className={`flex flex-col`}>
                                        <label className="text-black/75 uppercase font-thin">
                                            Category
                                        </label>
